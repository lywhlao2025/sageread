...
export const I18N_DICT: I18nDict = {
  ...
  "chat.quickAction.summary": { zh: "总结本页", en: "Summarize page" },
  "chat.quickAction.summary.prompt": { zh: "请帮我总结本页的核心要点和结论。", en: "Summarize the key points and conclusions on this page." },
  "chat.quickAction.analyze": { zh: "分析观点", en: "Analyze viewpoint" },
  "chat.quickAction.analyze.prompt": { zh: "请分析作者的观点，指出论据与可能的偏见。", en: "Analyze the author's viewpoint, including evidence and potential bias." },
  "chat.quickAction.mindmap": { zh: "生成思维导图", en: "Generate mind map" },
  "chat.quickAction.mindmap.prompt": { zh: "请基于当前内容生成思维导图。", en: "Create a mind map from the current content." },
